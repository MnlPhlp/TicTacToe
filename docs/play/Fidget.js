...
function make_square_14427631() {
  var F={procname:"fidgetClient.makeSquare",prev:framePtr,filename:"fidgetClient.nim",line:0};
  framePtr = F;
    if ((current_12582387[0].box.h < current_12582387[0].box.w)) {
    F.line = 25;
    HEX2BHEX3D_9980341(current_12582387[0].box, "x", ((current_12582387[0].box.w - current_12582387[0].box.h) / 2.0000000000000000e+00));
    F.line = 26;
    current_12582387[0].box.w = current_12582387[0].box.h;
    }
    
    if ((current_12582387[0].box.w < current_12582387[0].box.h)) {
    F.line = 28;
    current_12582387[0].box.h = current_12582387[0].box.w;
    }
    
    F.line = 29;
    nimCopy(current_12582387[0].screenBox, current_12582387[0].box, NTI11635147);
    F.line = 30;
    HEX2BHEX3D_9980341(current_12582387[0].box, "x", parent_12582382[0].screenBox.x);
    F.line = 31;
    HEX2BHEX3D_9980341(current_12582387[0].box, "y", parent_12582382[0].screenBox.y);
  framePtr = F.prev;
...
function draw_info_14530044() {
  ...
  framePtr = F;
    ...
    stroke_weight_14215233(1.0000000000000000e+00);
    F.line = 150;
    font_14210100(makeNimstrLit("IBM Plex Sans Regular"), 3.6000000000000000e+01, 2.0000000000000000e+02, 0.0, 1, 0);
    F.line = 151;
    ...
    constraints_14215502(0, 0);
    F.line = 180;
    fill_14215167(makeNimstrLit("#00ff00"), 1.0000000000000000e+00);
    F.line = 181;
    stroke_weight_14215233(1.0000000000000000e+00);
    F.line = 182;
    font_14210100(makeNimstrLit("IBM Plex Sans Regular"), 2.4000000000000000e+01, 2.0000000000000000e+02, 0.0, 0, 1);
...
function draw_settings_14730030() {
  ...
  framePtr = F;
    ...
    stroke_weight_14215233(1.0000000000000000e+00);
    F.line = 249;
    font_14210100(makeNimstrLit("IBM Plex Sans Regular"), 2.4000000000000000e+01, 2.0000000000000000e+02, 0.0, 0, 0);
    F.line = 250;
    ...
    stroke_weight_14215233(1.0000000000000000e+00);
    F.line = 268;
    font_14210100(makeNimstrLit("IBM Plex Sans Regular"), 2.4000000000000000e+01, 2.0000000000000000e+02, 0.0, 1, 0);
    F.line = 423;
...
function draw_main_frame_15225027() {
  ...
  framePtr = F;
    ...
    stroke_weight_14215233(1.0000000000000000e+00);
    F.line = 451;
    font_14210100(makeNimstrLit("IBM Plex Sans Bold"), 4.8000000000000000e+01, 2.0000000000000000e+02, 0.0, 1, 0);
    F.line = 452;
    ...
    F.line = 455;
    constraints_14215502(3, 3);
    F.line = 456;
    make_square_14427631();
    F.line = 80;
